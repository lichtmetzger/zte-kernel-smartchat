...
#ifdef CONFIG_FB_MSM_MIPI_DSI_HVGA
extern u32 LcdPanleID;
#endif
//< 2012/5/29-Read_lcd_id_from_reg_function-lizhiye- < short commond here >
#ifdef CONFIG_FB_MSM_MIPI_DSI_ROAMER2_HVGA
extern u32 LcdPanleID;
#endif
...
#ifdef CONFIG_FB_MSM_MIPI_DSI_HVGA
	if((LcdPanleID==LCD_PANEL_3P95_HX8357_IVO_YUSHUN)||(LcdPanleID==LCD_PANEL_3P95_HX8357_HANSTAR_LEAD))
	{
		pr_err("skip bta LcdPanleID=%d\n",LcdPanleID);
	}
	else
#endif	
//< 2012/5/29-Read_lcd_id_from_reg_function-lizhiye- < short commond here >
#ifdef CONFIG_FB_MSM_MIPI_DSI_ROAMER2_HVGA
	if((LcdPanleID == LCD_PANEL_3P5_HX8357_LEAD)||(LcdPanleID == LCD_PANEL_3P5_HX8357_TRULY))
	{
		pr_err("lizhiye, skip bta LcdPanleID=%d\n", LcdPanleID);
	}
	else 
#endif	
//>2012/5/29-Read_lcd_id_from_reg_function-lizhiye
