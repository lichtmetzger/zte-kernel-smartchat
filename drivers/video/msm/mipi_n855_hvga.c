...
BOE HX8357C initial
***************************************/
static char hx8357c_boe_para_0xb9[4]={0xB9,0xff,0x83,0x57};  
static char hx8357c_boe_para_0xb6[2]={0xb6,0x4c};  
static char hx8357c_boe_para_0x3a[2]={0x3a,0x77};  
static char hx8357c_boe_para_0xe9[2]={0xe9,0x20};
static char hx8357c_boe_para_0xcc[2]={0xcc,0x09};  
static char hx8357c_boe_para_0xb3[5]={0xB3,0x43,0x00,0x06,0x06}; 
static char hx8357c_boe_para_0xb1[7]={0xB1,0x00,0x13,0x12,0x12,0x83,0xAA};  
static char hx8357c_boe_para_0xc0[7]={0xC0,0x24,0x50,0x01,0x3C,0xC8,0x08}; 
static char hx8357c_boe_para_0xb4[8]={0xB4,0x01,0x40,0x00,0x2A,0x2A,0x0D,0x4F}; 
static char hx8357c_boe_para_0xba[17]={0xBA,0x00,0x56,0xD4,0x00,0x0A,0x00,0x10,0x32,0x6E,0x04,0x05,0x9A,0x14,0x19,0x10,0x40};  
static char hx8357c_boe_para_0xe0[68]={0xE0,0x00,0x00,0x00,0x00,0x13,0x00,0x1A,0x00,0x29,0x00,0x2D,0x00,0x41,0x00,0x4B,0x00,0x54,0x00,0x46,0x00,0x3F,0x00,0x3B,0x00,0x31,0x00,0x30,0x00,0x27,0x00,0x28,0x00,0x07,0x01,0x00,0x00,0x13,0x00,0x1A,0x00,0x29,0x00,0x2D,0x00,0x41,0x00,0x4B,0x00,0x54,0x00,0x46,0x00,0x3F,0x00,0x3B,0x00,0x31,0x00,0x30,0x00,0x27,0x00,0x28,0x00,0x07,0x00,0x00};                                                        
static char hx8357c_boe_para_0x11[2]={0x11,0x00}; 
static char hx8357c_boe_para_0x29[2]={0x29,0x00};  
...
static struct dsi_cmd_desc hx8357c_boe_display_on_cmds[] = 
{
	...
	{DTYPE_DCS_LWRITE, 1, 0, 0, 10, sizeof(hx8357c_boe_para_0xb9), hx8357c_boe_para_0xb9},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(hx8357c_boe_para_0xb6), hx8357c_boe_para_0xb6},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(hx8357c_boe_para_0x3a), hx8357c_boe_para_0x3a},	
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(hx8357c_boe_para_0xe9), hx8357c_boe_para_0xe9},		
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(hx8357c_boe_para_0xcc),hx8357c_boe_para_0xcc},	
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(hx8357c_boe_para_0xb3), hx8357c_boe_para_0xb3},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(hx8357c_boe_para_0xb1), hx8357c_boe_para_0xb1},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(hx8357c_boe_para_0xc0), hx8357c_boe_para_0xc0},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(hx8357c_boe_para_0xb4), hx8357c_boe_para_0xb4},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(hx8357c_boe_para_0xba), hx8357c_boe_para_0xba},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(hx8357c_boe_para_0xe0), hx8357c_boe_para_0xe0},
	{DTYPE_DCS_WRITE, 1, 0, 0, 120, sizeof(hx8357c_boe_para_0x11), hx8357c_boe_para_0x11},	
	{DTYPE_DCS_WRITE, 1, 0, 0, 10, sizeof(hx8357c_boe_para_0x29), hx8357c_boe_para_0x29},	
...
static char hx8357c_boe_para_0xb9[4]={0xB9,0xff,0x83,0x57};  
static char hx8357c_boe_para_0xcc[2]={0xcc,0x09};  
static char hx8357c_boe_para_0x35[2]={0x35,0x00};  
static char hx8357c_boe_para_0xb6[2]={0xb6,0x51};  
static char hx8357c_boe_para_0xb1[7]={0xb1,0x00,0x13,0x12,0x12,0x83,0xaa};  
static char hx8357c_boe_para_0xb4[8]={0xb4,0x02,0x40,0x00,0x2a,0x2a,0x0d,0x44}; 
static char hx8357c_boe_para_0xb3[5]={0xb3,0x43,0x0f,0x06,0x06}; 

static char hx8357c_boe_para_0xc0[7]={0xc0,0x24,0x24,0x01,0x3c,0xc8,0x08}; 
static char hx8357c_boe_para_0xe0[68]={0xe0,0x00,0x00,0x10,0x00,0x24,0x00,0x24,0x00,0x2B,0x00,0x32,0x00,0x40,0x00,0x4B,0x00,0x55,0x00,0x46,0x00,0x40,0x00,0x3B,0x00,0x33,0x00,0x2F,0x00,0x29,0x00,0x26,0x00,0x1E
,0x01,0x10,0x00,0x24,0x00,0x24,0x00,0x2B,0x00,0x32,0x00,0x40,0x00,0x4B,0x00,0x55,0x00,0x46,0x00,0x40,0x00,0x3B,0x00,0x33,0x00,0x2F,0x00,0x29,0x00,0x26,0x00,0x1E,0x00,0x00}; 
static char hx8357c_boe_para_0x3a[2]={0x3a,0x77};  
static char hx8357c_boe_para_0xe9[2]={0xe9,0x20};
static char hx8357c_boe_para_0xb0[2]={0xb0,0x68};  
//static char hx8357c_boe_para_0xc6[3]={0xc6,0x00,0xff};  
static char hx8357c_boe_para_0xba[17]={0xba,0x00,0x56,0xd4,0x00,0x0a,0x00,0x10,0x32,
	                                                             0x6e,0x04,0x05,0x9a,0x14,0x19,0x10,0x40};  
static char hx8357c_boe_para_0x11[2]={0x11,0x00}; 
static char hx8357c_boe_para_0x2a[5]={0x2a,0x00,0x00,0x3f,0x01}; 
static char hx8357c_boe_para_0x2b[5]={0x2b,0x00,0x00,0xdf,0x01}; 

static char hx8357c_boe_para_0x13[2]={0x13,0x00};  
static char hx8357c_boe_para_0x29[2]={0x29,0x00};  
static char hx8357c_boe_para_0x2c[2]={0x2c,0x00}; 
...
static struct dsi_cmd_desc hx8357c_boe_display_on_cmds[] = 
{
	...
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(hx8357c_boe_para_0xcc),hx8357c_boe_para_0xcc},	
	{DTYPE_DCS_WRITE, 1, 0, 0, 0, sizeof(hx8357c_boe_para_0x35), hx8357c_boe_para_0x35},	
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(hx8357c_boe_para_0xb6), hx8357c_boe_para_0xb6},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(hx8357c_boe_para_0xb1), hx8357c_boe_para_0xb1},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(hx8357c_boe_para_0xb4), hx8357c_boe_para_0xb4},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(hx8357c_boe_para_0xb3), hx8357c_boe_para_0xb3},
	...
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(hx8357c_boe_para_0x3a), hx8357c_boe_para_0x3a},	
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(hx8357c_boe_para_0xe9), hx8357c_boe_para_0xe9},	
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(hx8357c_boe_para_0xb0), hx8357c_boe_para_0xb0},
	//{DTYPE_DCS_LWRITE, 1, 0, 0, 1, sizeof(hx8357c_boe_para_0xc6), hx8357c_boe_para_0xc6},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(hx8357c_boe_para_0xba), hx8357c_boe_para_0xba},
	{DTYPE_DCS_WRITE, 1, 0, 0, 0, sizeof(hx8357c_boe_para_0x11), hx8357c_boe_para_0x11},	
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(hx8357c_boe_para_0x2a), hx8357c_boe_para_0x2a},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(hx8357c_boe_para_0x2b), hx8357c_boe_para_0x2b},
	{DTYPE_DCS_WRITE, 1, 0, 0, 150, sizeof(hx8357c_boe_para_0x13), hx8357c_boe_para_0x13},	
	{DTYPE_DCS_WRITE, 1, 0, 0, 10, sizeof(hx8357c_boe_para_0x29), hx8357c_boe_para_0x29},	
	{DTYPE_DCS_WRITE, 1, 0, 0, 0, sizeof(hx8357c_boe_para_0x2c), hx8357c_boe_para_0x2c},	
...
static char hx8357c_lead_para_0xb6[2]={0xB6,0x3C};  
...
static char hx8357c_lead_para_0xb1[7]={0xB1,0x00,0x16,0x18,0x18,0x83,0xAA};  
static char hx8357c_lead_para_0xc0[7]={0xC0,0x24,0x50,0x01,0x3C,0x1E,0x08}; 
...
static char hx8357c_lead_para_0xe0[68]={0xE0,0x00,0x00,0x00,0x00,0x04,0x00,0x09,0x00,0x12,0x00,0x25,0x00,0x3b,0x00,0x45,0x00,0x4c,0x00,0x4e,0x00,0x46,0x00,0x41,0x00,0x3a,0x00,0x36,0x00,0x31,0x00,0x31,0x00,0x2c,0x01,0x00,0x00,0x04,0x00,0x09,0x00,0x12,0x00,0x25,0x00,0x3b,0x00,0x45,0x00,0x4c,0x00,0x4e,0x00,0x46,0x00,0x41,0x00,0x3a,0x00,0x36,0x00,0x31,0x00,0x31,0x00,0x2c,0x00,0x00};                                                        
...
//LcdPanleID = (u32)LCD_PANEL_3P95_HX8357C_BOE;
