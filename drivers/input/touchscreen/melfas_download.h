...
int mcsdl_download_binary_data(struct melfas_ts_data *ts);			// with binary type .c   file.
int mcsdl_download_binary_file(struct melfas_ts_data *ts);			// with binary type .bin file.
