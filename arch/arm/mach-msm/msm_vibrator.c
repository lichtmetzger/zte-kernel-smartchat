...
static volatile int g_vibrator_status=0;
#if DEBUG
...
static void pmic_vibrator_on(struct work_struct *work)
{
	...
	vibrator_on_delay = (vibrator_on_delay > 15000 ? 15000 : vibrator_on_delay);
...
static int tureis_create_vibrator_sysfs(void)
{
	int ret;
