...
struct wake_lock prevent_idle_lock;//LHX_20120120 add
...
static void suspend(struct work_struct *work)
{
    ...
    wake_lock(&prevent_idle_lock);//LHX_20120120 add
#ifdef CONFIG_ZTE_PLATFORM
    ...
    wake_unlock(&prevent_idle_lock);    //LHX_20120120 add
#ifdef CONFIG_ZTE_PLATFORM
...
static int __init wakelocks_init(void)
{
    ...
    wake_lock_init(&prevent_idle_lock, WAKE_LOCK_IDLE, "prevent_idle");//LHX_20120120 add
...
err_platform_device_register:
    ...
    wake_lock_destroy(&prevent_idle_lock);//LHX_20120120 add
#ifdef CONFIG_WAKELOCK_STAT
