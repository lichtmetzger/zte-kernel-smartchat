...
-------- 	----	   -----------------------------				----------------------
2012-06-26   yaosujuan Set the tcp windows size >128k         ZTE_YSJ_TCP_20120626
==========================================================================================*/
...
//ZTE_YSJ_TCP_20120626 add
#ifdef CONFIG_ZTE_PLATFORM
int sysctl_tcp_force_windows_size_128k __read_mostly = 0;
#endif
//ZTE_YSJ_TCP_20120626 end
			       ...
			       __u32 init_rcv_wnd)
{
	...
	//ZTE_YSJ_TCP_20120626 add
	#ifdef CONFIG_ZTE_PLATFORM	  
	if(sysctl_tcp_force_windows_size_128k) 	{	   
		*rcv_wscale = 1;    
		*rcv_wnd = 65535U;	
		}
	#endif//ZTE_YSJ_TCP_20120626 end
